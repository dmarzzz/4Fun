...
export const useAsciiEffect = (
  ...
  const [asciiEffect, setAsciiEffect] = useState(null);

  useEffect(() => {
    if (renderer) {
      setAsciiEffect(new AsciiEffect(renderer, charSet, options));
    }
...
class AsciiEffect {
  constructor(renderer, charSet = ' .:-=+*#%@', options = {}) {
    // ...rest of the AsciiEffect constructor
  ...
  // ...rest of the AsciiEffect methods
}
